...
insert into goals (name, date, totalAmount, fulfilled, savedMoney, accounts_id ) values ("trip", '20201212', 0, 0, 0, 4);

UPDATE accounts SET disponible = disponible + 200 WHERE accounts_id = 1;
